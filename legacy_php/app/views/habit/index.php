<div class="container mx-auto px-4 py-6">
    ...
    <!-- Stats Overview -->
    <div id="habit-stats" class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="modal-content bg-white rounded-xl shadow-2xl">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button id="close-edit-modal" class="text-text-secondary hover:text-text p-1">
                ...
                <form id="edit-habit-form">
                    ...
                    <!-- Daily Target -->
                    <div class="mb-6">
                        <label for="edit-daily-target" class="block text-sm font-medium text-text-secondary mb-2">
                            Daily Target
                        </label>
                        <div class="flex items-center space-x-3">
                            <button type="button" id="decrease-target" class="btn btn-icon btn-secondary">
                            ...
                            <input type="number" 
                                   ...
                                   value="1"
                                   readonly>
                            <button type="button" id="increase-target" class="btn btn-icon btn-secondary">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                            </button>
                            <span class="text-text-secondary text-sm">times per day</span>
                        </div>
                    </div>
