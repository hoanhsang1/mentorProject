...
class CalendarApp {
    ...
    updateDayEvents() {
        ...
        const dayEvents = this.events.filter(event => {
            ...
            // Kiểm tra nếu selectedDate nằm trong khoảng event (String comparison)
            // selectedDate format: YYYY-MM-DD
            // eventEndDate/StartDate format: YYYY-MM-DD

            const isInRange = this.selectedDate >= eventStartDate && this.selectedDate <= eventEndDate;
